...
public class App extends Application {
    ...
    //App credentials
    private static final String APPLICATION_ID = "85321";
    private static final String AUTH_KEY = "HKj7Jm3h79mDQY7";
    private static final String AUTH_SECRET = "Uxfwuh7QPU5GmeC";
    private static final String ACCOUNT_KEY = "smTYcBz7qsWmGw52_Tyz";
